# Generated by Django 5.0 on 2023-12-13 18:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('developpeurs', models.ManyToManyField(related_name='developpeurs', through='Projet.Developpeur', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='developpeur',
            name='projet',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Projet.projet'),
        ),
    ]
